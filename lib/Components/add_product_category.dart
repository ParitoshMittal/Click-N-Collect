...
class _AddProductCategoryState extends State<AddProductCategory> {
  ...
  Future<void> _uploadImageAndSaveData() async {
    ...
    try {
      final fileName = DateTime.now().millisecondsSinceEpoch.toString() + '.png'; // Add .png extension
      final firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance
          .ref()
          .child('ProductCategory/$fileName');
      ...
      await FirebaseFirestore.instance.collection('ProductCategory').add(productCategoryData);
